...
LINEAGE-SOURCE()
{
    ...
    git clone https://github.com/RaghuVarma331/vendor_lineage.git -b pie vendor/lineage
    git clone https://github.com/LineageOS/android_packages_resources_devicesettings.git -b lineage-16.0 packages/resources/devicesettings	
    git clone https://github.com/RaghuVarma331/android_device_lineage_sepolicy.git -b pie device/lineage/sepolicy
    git clone https://github.com/RaghuVarma331/android_device_nokia_Dragon.git -b lineage-16.0 device/nokia/Dragon
    git clone https://github.com/RaghuVarma331/android_kernel_nokia_sdm660.git -b pie --depth=1 kernel/nokia/sdm660	
    git clone https://gitlab.com/RaghuVarma331/vendor_nokia_dragon.git -b pie vendor/nokia/Dragon
    curl -s -X POST https://api.telegram.org/bot$Telegram_Api_code/sendMessage -d chat_id=$chat_id -d text="
    ...
    git clone https://github.com/RaghuVarma331/android_device_nokia_Onyx.git -b lineage-16.0 device/nokia/Onyx
    ...
    git clone https://github.com/LineageOS/android_device_lineage_sepolicy.git -b lineage-16.0 device/lineage/sepolicy
...
DRG-TWRP-O-SOURCE()
{
    ...
    ⬇️ Download https://sourceforge.net/projects/b2n-sprout/files/Twrp-3.2.3-0
